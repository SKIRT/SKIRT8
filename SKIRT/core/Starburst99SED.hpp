...
/** Starburst99SED is a class that represents spectral energy distributions of simple stellar
    ...
    */
class Starburst99SED : public StellarSED
{
    ITEM_CONCRETE(Starburst99SED, StellarSED, "a Starburst99 simple stellar population SED")
...
protected:
    /** This function constructs a temporary instance of the Starburst99SEDFamily class to
