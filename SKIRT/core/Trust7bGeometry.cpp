...
double Trust7bGeometry::density(Position bfr) const
{
    double x, y, z;
    bfr.cartesian(x,y,z);
...
Position Trust7bGeometry::generatePosition() const
{
    double z = _b * (random()->uniform()-0.5);
    double t = _Rout/_Rc;
    double Rf = _Rc * sqrt( pow(1.0+t*t,random()->uniform())-1.0 );
...
double Trust7bGeometry::SigmaX() const
{
...
double Trust7bGeometry::SigmaY() const
{
...
double Trust7bGeometry::SigmaZ() const
{
