...
{
    ITEM_ABSTRACT(DustMix, SimulationItem, "a dust mix")

    PROPERTY_BOOL(writeMix, "output a data file with the optical properties of the dust mix")
        ATTRIBUTE_DEFAULT_VALUE(writeMix, "true")

    PROPERTY_BOOL(writeMeanMix, "output a data file with the mean optical properties of the dust mix")
        ATTRIBUTE_DEFAULT_VALUE(writeMeanMix, "true")
