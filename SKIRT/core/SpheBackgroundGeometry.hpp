...
{
    ITEM_CONCRETE(SpheBackgroundGeometry, Geometry,
                  "a spherical background geometry with an anisotropic inward radiation field")
...
private:
    ...
    const double& _rbg{_backgroundRadius};
};
