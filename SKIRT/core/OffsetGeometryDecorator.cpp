...
double OffsetGeometryDecorator::probabilityForDirection(int ell, Position bfr, Direction bfk) const
{
    double x,y,z;
    bfr.cartesian(x,y,z);
...
Direction OffsetGeometryDecorator::generateDirection(int ell, Position bfr) const
{
    double x,y,z;
    bfr.cartesian(x,y,z);
