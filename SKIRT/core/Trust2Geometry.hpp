...
{
    ITEM_CONCRETE(Trust2Geometry, GenGeometry, "the geometry from the TRUST2 benchmark model")
    ITEM_END()
...
private:
    ...
    double _M0{0.}, _L0{0.}, _R0{0.}, _rho0{0.};
    double _M1{0.}, _R1{0.}, _rho1{0.};
    Position _bfr1;
    double _M2{0.}, _R2{0.}, _rho2{0.};
    Position _bfr2;
};
