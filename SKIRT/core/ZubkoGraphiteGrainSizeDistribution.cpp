...
ZubkoGraphiteGrainSizeDistribution::ZubkoGraphiteGrainSizeDistribution(SimulationItem* parent, double C)
{
    parent->addChild(this);
    setProportionalityFactor(C);
    setup();
}
...
{
    return proportionalityFactor() * dnda_gra(a);
}
