...
extern double gaDefPConv;
extern int   gaDefNConv;
extern double gaDefPMut;
extern double gaDefPCross;
extern int   gaDefPopSize;
extern int   gaDefNPop;
extern double gaDefPRepl;
extern int   gaDefNRepl;
extern int   gaDefNumOff;
extern double gaDefPMig;
