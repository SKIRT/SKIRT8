...
public:
  ...
  GAScalingScheme() {}
  GAScalingScheme(const GAScalingScheme& s) : GAID() { copy(s); }
...
public:
  ...
  GASharing(GAGenome::Comparator func,
    ...
    { N=0; d=(double*)0; df=func; _sigma = cut; _alpha = a; _minmax = 0; }
  GASharing(double cut=gaDefSharingCutoff, double a=1.0)
    { N=0; d=(double*)0; df=0; _sigma = cut; _alpha = a; _minmax = 0; }
  GASharing(const GASharing & arg) : GAScalingScheme() { N=0; d=(double*)0; copy(arg); }
