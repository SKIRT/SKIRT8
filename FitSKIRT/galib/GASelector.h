...
public:
  ...
  GASelectionScheme(const GASelectionScheme& orig) : GAID() { copy(orig); }
...
public:
  ...
  GARankSelector(const GARankSelector& orig) : GASelectionScheme() { copy(orig); }
...
public:
  ...
  GASelectionScheme(w)
    { psum = (double*)0; n = 0; }
  GARouletteWheelSelector(const GARouletteWheelSelector& orig) : GASelectionScheme()
    { psum = (double*)0; n = 0; copy(orig); }
...
public:
  ...
  GATournamentSelector(const GATournamentSelector& orig) : GARouletteWheelSelector() { copy(orig); }
...
public:
  ...
  GAUniformSelector(const GAUniformSelector& orig) : GASelectionScheme() { copy(orig); }
...
public:
  ...
  GASRSSelector(const GASRSSelector& orig) : GASelectionScheme()
...
public:
  ...
  GADSSelector(const GADSSelector& orig) : GASelectionScheme() {
    fraction = (double*)0;
    choices = (unsigned int *)0;
    idx = (unsigned int *)0;
    n = 0;
