...
GA3DArrayGenome<T>(w,h,d,f,u) {
  ...
  GA3DArrayGenome<T>::initializer(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_INITIALIZER);
  GA3DArrayGenome<T>::mutator(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_MUTATOR);
  GA3DArrayGenome<T>::comparator(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_COMPARATOR);
  GA3DArrayGenome<T>::crossover(GA3DArrayAlleleGenome<T>::DEFAULT_3DARRAY_ALLELE_CROSSOVER);
}
