...
template <class T> inline GAGenome *
...
GA1DArrayGenome<T>(length, f, u){
  ...
  GA1DArrayGenome<T>::initializer(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_INITIALIZER);
  GA1DArrayGenome<T>::mutator(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_MUTATOR);
  GA1DArrayGenome<T>::comparator(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_COMPARATOR);
  GA1DArrayGenome<T>::crossover(GA1DArrayAlleleGenome<T>::DEFAULT_1DARRAY_ALLELE_CROSSOVER);
}
...
template <class ARRAY_TYPE> inline void
...
template <class ARRAY_TYPE> inline int
GA1DArrayAlleleGenome<ARRAY_TYPE>::FlipMutator(GAGenome & c, double pmut)
{
  GA1DArrayAlleleGenome<ARRAY_TYPE> &child=
    DYN_CAST(GA1DArrayAlleleGenome<ARRAY_TYPE> &, c);
  int n, i;
...
template <class ARRAY_TYPE> inline int
GA1DArrayGenome<ARRAY_TYPE>::SwapMutator(GAGenome & c, double pmut)
{
...
template <class ARRAY_TYPE> inline double
