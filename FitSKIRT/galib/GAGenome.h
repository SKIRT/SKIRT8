...
public:
  ...
  void addnevals() {_neval++;}
  double score() const { evaluate(); return _score; }
  double score(double s){ _evaluated=gaTrue; return _score=s; }
  ...
  double compare(const GAGenome& g) const {return (*cmp)(*this,g);}
  ...
  GABoolean isEvaluated() const { return _evaluated; }
