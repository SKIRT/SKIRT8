...
// Must do a special case for double/double.  Any floats that get passed to this
// routine will be cast to doubles, but then we need to force them back to a
// double if FLOAT is the type that is expected.  Kind of sucks, eh?
